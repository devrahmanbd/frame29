    ...
    <BandSequence route="/">
      ...
      <HeroBand
        ...
        visual={
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }}>
            <img src={dashboardImg} alt="Dashboard" className="w-full h-auto rounded-xl shadow-2xl border border-border" />
          </motion.div>
        }
        actions={
          <>
      ...
      <Band surface="glass" divided labelledBy="platform-title">
        ...
        >
          ...
          <motion.div variants={itemVariants} whileHover={{ y: -4 }} className="md:col-span-2 lg:col-span-2 rounded-fq-lg bg-card border border-border/70 p-8 flex flex-col justify-between relative overflow-hidden group shadow-sm transition-shadow hover:shadow-md">
            <div className="z-10 max-w-lg">
              <span className="grid size-12 place-items-center rounded-fq-md bg-primary/10 text-primary mb-5">
            ...
            <div className="absolute right-0 bottom-0 w-2/3 h-2/3 opacity-30 group-hover:opacity-50 transition-opacity duration-500 translate-y-12 translate-x-12">
              <img src={mobileStoreImg} alt="Mobile Checkout" className="w-full h-full object-cover object-top rounded-tl-2xl shadow-2xl border-t border-l border-border" />
            </div>
          </motion.div>

          {/* Card 2: Spans 2 rows on large screens */}
          <motion.div variants={itemVariants} whileHover={{ y: -4 }} className="md:col-span-1 lg:row-span-2 rounded-fq-lg bg-muted/30 border border-border/70 p-8 flex flex-col relative overflow-hidden group shadow-sm transition-shadow hover:shadow-md">
            <div className="z-10">
              <span className="grid size-12 place-items-center rounded-fq-md bg-primary/10 text-primary mb-5">
            ...
            <div className="mt-auto relative rounded-fq-md border border-border bg-background p-4 shadow-sm w-full group-hover:scale-[1.02] transition-transform duration-500">
          ...
          {/* Card 3 */}
          <motion.div variants={itemVariants} whileHover={{ y: -4 }} className="md:col-span-1 rounded-fq-lg bg-card border border-border/70 p-8 flex flex-col justify-between relative shadow-sm transition-shadow hover:shadow-md">
            <div>
              <span className="grid size-12 place-items-center rounded-fq-md bg-primary/10 text-primary mb-5">
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={cn(
                    "min-h-[48px] flex items-center gap-2.5 rounded-full px-6 py-2.5 text-sm font-medium transition-all relative overflow-hidden group",
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  isFeatured
                    ? "border-white/20 dark:border-white/10 bg-card/40 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.08),inset_0_1px_1px_rgba(255,255,255,0.2)] ring-1 ring-black/5 dark:ring-white/5"
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-8 border-t border-border/50 pt-6">
                    ...
                    <p className="text-xs text-emerald-500 dark:text-emerald-400 font-bold tracking-wide uppercase mt-3">0% transaction fees</p>
                  </div>
                ...
                <div className="mt-10 pt-6 border-t border-border/40">
                  <Link
                    ...
                    search={{ mode: "signup" }}
                    className={cn(
                      "w-full inline-flex min-h-[48px] items-center justify-center rounded-full text-sm font-bold transition-all",
                      isFeatured
        ...
        >
          {TESTIMONIALS.cases.map((item) => (
            <motion.div
              variants={itemVariants}
              key={item.id}
              className="rounded-fq-lg border border-border/70 bg-card/60 p-8 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow"
            >
              <div>
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-border/50">
                  {item.image ? (
                    <img src={item.image} alt={item.merchant} className="size-12 shrink-0 rounded-full object-cover shadow-sm ring-2 ring-border/50" />
                  ) : (
                    <div className="grid size-12 shrink-0 place-items-center rounded-full bg-primary text-primary-foreground font-bold text-lg shadow-sm">
                      {item.mark}
                    </div>
                  )}
                  <div>
                    <h3 className="text-base font-bold text-foreground">{item.merchant}</h3>
