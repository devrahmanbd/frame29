...
export const Route = createFileRoute("/docs/")({
  loader: async () => {
    ...
    return { origin: site.origin, demoSlug: site.demoSlug };
  },
  head: ({ loaderData }) => {
      ...
      <div className="mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="mt-4 flex flex-col sm:flex-row flex-wrap gap-3 text-sm">
          <Link
            ...
            className="w-full sm:w-auto min-h-11 inline-flex items-center justify-center gap-2 rounded-fq-md bg-primary px-5 py-2.5 font-semibold text-primary-foreground group"
          >
        ...
        <div className="mt-10 overflow-hidden rounded-fq-lg border border-border/80 bg-card">
                ...
                {group.pages.map((page) => (
                  <li key={page.slug}>
                    <Link
                      ...
                      className="block rounded-fq-md border border-border p-4 hover:bg-accent"
                    >
                      <span className="font-medium">{page.title[lang]}</span>
