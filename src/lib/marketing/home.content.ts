...
export const HERO = {
  ...
  ctaPrimary: "Open my store free",
  ctaSecondary: "See a live store",
  note: "14-day trial · no card · no setup fee · export your data any time",
...
export const FINAL_CTA = {
  ...
  sub: "Open the store, connect bKash, ship the first parcel — the trial is long enough to prove it against your real catalogue.",
  subBn: "ফ্রি শুরু করুন, বিকাশ সংযুক্ত করুন, আজই একটি সত্যিকারের অর্ডার নিন।",
  ctaPrimary: "Open my store free",
